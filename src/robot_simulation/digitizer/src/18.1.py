        ...
        try:
            ...
            for i in l2:
                ...
                cv2.putText(im, str(j), (i[0] - 20, i[1] - 20),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)    #RED_COLOR
            resized_img5 = cv2.resize(im,None,fx=0.5, fy=0.5, interpolation = 
cv2.INTER_CUBIC)
            resized_img5 = cv2.resize(resized_img5, (270,365))
            cv2.imshow("arrangedShapes",resized_img5)
            ...
            resized_img4 = cv2.resize(image3,None,fx=0.5, fy=0.5, interpolation = 
cv2.INTER_CUBIC)
            resized_img4 = cv2.resize(resized_img4, (270,365))
            cv2.imshow("Image_2", resized_img4)
            ...
            resized_img1 = cv2.resize(image5,None,fx=0.5, fy=0.5, interpolation = 
cv2.INTER_CUBIC)
            resized_img1 = cv2.resize(resized_img1, (270,365))
            cv2.imshow("TRACKKK", resized_img1)
            ...
            resized_img2 = cv2.resize(thresh,None,fx=0.5, fy=0.5, interpolation = 
cv2.INTER_CUBIC)
            resized_img2 = cv2.resize(resized_img2, (270,365))
            cv2.imshow("thresh", resized_img2)
            ...
            resized_img3 = cv2.resize(result_perspectiveChange,None,fx=0.5, fy=0.5, interpolation = 
cv2.INTER_CUBIC)
            resized_img3 = cv2.resize(resized_img3, (270,365))
            cv2.imshow('result_perspectiveChange',resized_img3) 
